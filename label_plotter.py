...
frame_folder = 'frames/20231124_163447/'  # Replace with your frame folder path
csv_file = 'labels/20231124_163447_label1.txt'     # Replace with your CSV file path

# Output video parameters
output_video_path = 'output_video_420.mp4'
...
for frame_idx in tqdm(range(len(os.listdir(frame_folder)))):
    ...
    if frame_idx in coordinates:
        circle_center = coordinates[frame_idx]
